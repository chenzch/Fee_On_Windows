...
#define FEE_TYPES_SW_MAJOR_VERSION             6
...
typedef struct
{
    uint32        SubAddressAreaAddr;           /**< @brief Logical address of subAddressArea on flash */
...
typedef struct
{
    ...
    uint32               StartAddr;          /**< @brief Start address of Fee cluster in flash address space */
